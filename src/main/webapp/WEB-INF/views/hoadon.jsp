	...
	<div class="left-content">
		<div class="row">
			...
			<div class="col-sm-12 col-md-5 form-group">
				...
				<input name="tenkhachhang" type="text" id="tenkhachhang" class="form-control" placeholder="Nhập Vào Tên Khách Hàng" /><br/>
				
				<label for="sdt">Số Điện Thoại: </label> <br/>
				<input name="sdt" type="text" id="sdt" class="form-control" placeholder="Nhập Vào Số Điện Thoại" /><br/>
				
				<label for="giatien">Giá Tiền: </label> <br/>
				<input name="giatien" type="number" id="giatien" class="form-control" placeholder="Nhập Vào giá tiền" /><br/>
				
				<label for="diachi">Địa Chỉ: </label> <br/>
				<textarea rows="5" name=""diachi"" id=""diachi"" class="form-control" placeholder="Nhập Vào Địa Chỉ"></textarea><br/>
				
				<label for="Tinhtrang">Tình Trạng: </label> <br/>
				<label class="radio-inline"><input id="rd-chapnhan" type="radio" name="Tinhtrang" value="chapnhan" checked>Chấp Nhận</label>
				<label class="radio-inline"><input id="rd-tuchoi" type="radio" name="Tinhtrang" value="tuchoi">Từ Chối</label><br/><br/>
				
				<p>
					<button class="btn btn-primary" id="btnThemSanPham">Cập Nhật</button>
					...
					<tbody>
						<c:forEach var="hoadon" items="${listhoadon }">
							<tr>
								<td>
									<div class="checkbox">
									  <label><input class="checkboxsanpham" type="checkbox" value="${hoadon.getMahoadon() }"></label>
									</div>
								</td>
								<td class="tensp" data-masp="${hoadon.getMahoadon() }"> ${hoadon.getTenkhachhang() }</td>
								<td class="">${hoadon.getSodt() }</td>
								<td class="gianhcho">${hoadon.isTinhtrang() }</td>
								<td style="color: white;" class=" btn btn-warning capnhatsanpham" data-id="${hoadon.getMahoadon() }">Sửa</td>
							  </tr>
						</c:forEach>
					</tbody>
				</table>
									...
									<ul id="menu" >
										<c:choose>
								        	<c:when test="${nhanVien.getChucVu().getMachucvu() == 1}">
												...
												<li><a href="index.html"><i class="fa fa-list-alt dangxuat"></i> <span>Quản Lý Hóa Đơn</span><div class="clearfix"></div></a></li>
